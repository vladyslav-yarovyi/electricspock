...
public class RobolectricVersionChecker {
    ...
    private String[] acceptedVersions = new String[] {"3.3","3.4", "3.5", "3.6", "3.7", "3.8", "4.3", "4.11"};
    ...
    public void checkRobolectricVersion(String ver) {
        ...
        if (!isVersion(ver, acceptedVersions))
            throw new RuntimeException(
                    "This version of ElectricSpock supports Robolectric 3.3.x to 3.8.x, 4.3.x, and 4.11.x only. "
